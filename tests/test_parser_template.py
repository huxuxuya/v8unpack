...
class TestTemplateParsing(unittest.TestCase):
    ...
    def test_extract(self):
        src_filename = os.path.join(self.data_dir, 'apam_add_schema_old.cf')
        dest_dir0 = os.path.join(self.temp_dir, 'apam-tmplt-0')
        dest_dir1 = os.path.join(self.temp_dir, 'apam-tmplt-1')
        dest_dir2 = os.path.join(self.temp_dir, 'apam-tmplt-2')
        dest_dir3 = os.path.join(self.temp_dir, 'apam-tmplt-3')
